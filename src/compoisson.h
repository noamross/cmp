...
extern NumericVector dcom(double x, double lambda, double nu, double z, double log_error, int maxit);
extern double dcom_single(double x, double lambda, double nu, double z);
extern NumericVector pcom(double q, double lambda, double nu, bool log, double z, double log_error, int maxit);
extern NumericVector qcom(NumericVector p, double lambda, double nu, bool log, double z, double log_error, int maxit);
